...
import com.pihen.d3restapi.service.configuration.ConfigurationService;
import com.pihen.d3restapi.service.remote.exception.D3ServerCommunicationException;
import com.pihen.d3restapi.service.remote.gson.SpringGsonConverter;
import com.pihen.d3restapi.service.util.AnnotationUtils;
...
public class SpringRemoteService<T extends RemoteEntity> implements
	...
	public T receiveEntity(Configuration configuration) throws D3ServerCommunicationException {
		...
		T result = null;
		try {
			result = receiveEntity(configurationService.decorateUrl(annotation.url(), configuration));
