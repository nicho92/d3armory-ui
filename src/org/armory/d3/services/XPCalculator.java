...
public class XPCalculator {
	...
	public void init() {
	      try {
	    	  InputStreamReader fr = new InputStreamReader( new URL("https://raw.githubusercontent.com/nicho92/d3armory-ui/master/src/org/armory/d3/ui/data/XP.csv").openStream(),"ISO-8859-1");
